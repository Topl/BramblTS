...
export class KeyInitializerVector {
  constructor(
    ...
    public curve25519: string,
    public ed25519: spec.SecretKey,
    public vrfEd25519: string,
    public extendedEd25519: x_spec.SecretKey,
  ) {}

  static fromJson(json: any): KeyInitializerVector {
    const inputs = json.inputs;
    const outputs = json.outputs;

    const mnemonic = inputs.mnemonic;
    const password = inputs.password;
    const curve25519 = outputs.curve25519;
    const ed25519 = outputs.ed25519;
    const vrfEd25519 = outputs.vrfEd25519;
    const extendedEd25519 = outputs.extendedEd25519;

    const ed25519Sk = new Ed25519Initializer(ed25519).fromBytes(hexToUint8Array(ed25519)) as spec.SecretKey;
    const extendedEd25519Sk = new ExtendedEd25519Initializer(new ExtendedEd25519()).fromBytes(
      hexToUint8Array(extendedEd25519),
    ) as x_spec.SecretKey;

    return new KeyInitializerVector(mnemonic, password, curve25519, ed25519Sk, vrfEd25519, extendedEd25519Sk);
  }
}
