...
export namespace google.protobuf.compiler {
    ...
    export class CodeGeneratorRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            parameter?: string;
            proto_file: dependency_1.google.protobuf.FileDescriptorProto[];
        ...
        get proto_file() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.google.protobuf.FileDescriptorProto, 15) as dependency_1.google.protobuf.FileDescriptorProto[];
        }
        set proto_file(value: dependency_1.google.protobuf.FileDescriptorProto[]) {
        ...
        static fromObject(data: {
            file_to_generate: string[];
            parameter?: string;
            proto_file?: ReturnType<typeof dependency_1.google.protobuf.FileDescriptorProto.prototype.toObject>[];
            ...
            const message = new CodeGeneratorRequest({
                ...
                proto_file: data.proto_file.map(item => dependency_1.google.protobuf.FileDescriptorProto.fromObject(item))
            });
        ...
        toObject() {
            ...
            if (this.proto_file != null) {
                data.proto_file = this.proto_file.map((item: dependency_1.google.protobuf.FileDescriptorProto) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.proto_file.length)
                writer.writeRepeatedMessage(15, this.proto_file, (item: dependency_1.google.protobuf.FileDescriptorProto) => item.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 15:
                        reader.readMessage(message.proto_file, () => pb_1.Message.addToRepeatedWrapperField(message, 15, dependency_1.google.protobuf.FileDescriptorProto.deserialize(reader), dependency_1.google.protobuf.FileDescriptorProto));
                        break;
                    case 3:
    ...
    export namespace CodeGeneratorResponse {
        ...
        export class File extends pb_1.Message {
            ...
            constructor(data?: any[] | {
                ...
                content?: string;
                generated_code_info?: dependency_1.google.protobuf.GeneratedCodeInfo;
            }) {
                super();
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
                if (!Array.isArray(data) && typeof data == "object") {
            ...
            get generated_code_info() {
                return pb_1.Message.getWrapperField(this, dependency_1.google.protobuf.GeneratedCodeInfo, 16) as dependency_1.google.protobuf.GeneratedCodeInfo;
            }
            set generated_code_info(value: dependency_1.google.protobuf.GeneratedCodeInfo) {
            ...
            static fromObject(data: {
                ...
                insertion_point?: string;
                content?: string;
                generated_code_info?: ReturnType<typeof dependency_1.google.protobuf.GeneratedCodeInfo.prototype.toObject>;
            }): File {
                ...
                if (data.generated_code_info != null) {
                    message.generated_code_info = dependency_1.google.protobuf.GeneratedCodeInfo.fromObject(data.generated_code_info);
                }
                return message;
            }
            toObject() {
                ...
                while (reader.nextField()) {
                    ...
                    switch (reader.getFieldNumber()) {
                        ...
                        case 15:
                            ...
                            break;
                        case 16:
                            reader.readMessage(message.generated_code_info, () => message.generated_code_info = dependency_1.google.protobuf.GeneratedCodeInfo.deserialize(reader));
                            break;
                        default: reader.skipField();
                    }
                }
