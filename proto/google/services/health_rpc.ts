...
import * as dependency_1 from "./../models/health_models";
...
export namespace grpc.health.v1 {
    ...
    export class HealthCheckResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            status?: dependency_1.grpc.health.v1.ServingStatus;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get status() {
            return pb_1.Message.getFieldWithDefault(this, 1, dependency_1.grpc.health.v1.ServingStatus.UNKNOWN) as dependency_1.grpc.health.v1.ServingStatus;
        }
        set status(value: dependency_1.grpc.health.v1.ServingStatus) {
            pb_1.Message.setField(this, 1, value);
        }
        static fromObject(data: {
            status?: dependency_1.grpc.health.v1.ServingStatus;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.status != dependency_1.grpc.health.v1.ServingStatus.UNKNOWN)
