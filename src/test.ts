...
import { ExtendedEd25519Initializer } from './crypto/generation/key_initializer/extended_ed25519_initializer';
...
console.log('checking signature -> ', checkVerify);
console.log('others -> ', sig);
